...
class ColumnsControllerTest < ActionController::TestCase
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post :create, column: { Done: @column.Done, In_Process: @column.In_Process, To_Do: @column.To_Do, To_Verify: @column.To_Verify }
    end
  ...
  test "should update column" do
    patch :update, id: @column, column: { Done: @column.Done, In_Process: @column.In_Process, To_Do: @column.To_Do, To_Verify: @column.To_Verify }
    assert_redirected_to column_path(assigns(:column))
  end
